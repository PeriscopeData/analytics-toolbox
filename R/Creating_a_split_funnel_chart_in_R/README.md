...
![image1](/R/Creating_a_split_funnel_chart_in_R/Images/split_funnel.png "image1")

Funnel charts are a common way to visualize conversion for various stages in a business process.

Sometimes, it could be interesting to visualize a funnel split by demographic - I recommend just limiting the split to two groups - anything more and the value of coloring the groups would be greatly diminished by the confusion of comparing the bars in the series.
